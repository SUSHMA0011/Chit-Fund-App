              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
					...
					<a href="bid.php?id=<?php echo $id; ?>&bdate=<?php echo $bdate; ?>&btime=<?php echo $btime; ?>&bamt=<?php echo $bamt; ?>"><button class="btn btn-primary btn-rounded btn-fw"> View Bid </button></a>
