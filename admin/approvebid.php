                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <ul class="list-star">
                      ...
                      <li>Bidding Date: <?php echo $bdate; ?></li>
                      <li>Bidding Time: <?php echo $btime; ?></li>
                      <li>Bidding Amount: <?php echo $bamt; ?></li>
                    </ul>
					<a href="approvebidusers.php?id=<?php echo $id; ?>&bdate=<?php echo $bdate; ?>&btime=<?php echo $btime; ?>"><button type="button" class="btn btn-primary btn-rounded btn-fw"> View </button></a>
                  </div>
                </div>
              </div>
			  <?php
