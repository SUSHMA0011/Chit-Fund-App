...
<div class= "app-container">
    ...
    <div class="middle-box">
        <h1><?php echo $pay; ?>.00<span>INR</span></h1>
  ...
  <form method="POST" action="#">
    ...
    <label>CVV</label><br>
    <input type="password" name="cvv" class="cvc-field" required="required" pattern="[0-9]*" maxlength="4" placeholder="xxx">
    </div>
...
<!--    <button type="button" class="pay-btn">Pay Now</button> -->
	...
	if(isset($_POST['pay']))
	{
		include("config.php");
		$date=date('Y-m-d');
		$query = "insert into payment(pid,email,month,date,amount) values('".$_SESSION['id']."','".$_SESSION['user']."','".$mon."','".$date."','".$pay."')";
    ...
    <p><i style="font-size:12px" class="fa">&#xf023;</i> This is a secure 128-bit SSL Encrypted payment.</p>
      ...
      <footer class="footer">
        <p>&copy; 2022 TimeToBid Ltd  &middot; <a href="https://www.ajiofiber.com">Terms of Service</p></a>
    </footer>
